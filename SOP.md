...
For a named LAN or tailnet read-only deployment, use the dedicated runtime,
never the legacy `skcapstone dashboard` command:

```bash
skdashboard-read-only --host 10.0.0.139 --port 7778
