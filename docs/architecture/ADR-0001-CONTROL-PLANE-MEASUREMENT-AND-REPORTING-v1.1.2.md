...
- capture time: `2026-08-24T02:45:44.450644Z`;
- exit status: `0`;
- raw projection path: `docs/review/SKCP-00-BOARD-PROJECTION-v1.1.2.json`;
- raw command-stream SHA256:
  `c67cdfac8cd1600531d369e30f349b1c4208154d5d85d4cc6a9214756a9289f7`; and
- raw cardinality: 732 unique card IDs.

The raw projection is parsed before use. A separate canonical relevant-board
